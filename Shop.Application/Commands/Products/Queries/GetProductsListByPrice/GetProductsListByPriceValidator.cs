...
{
    public class GetProductsListByPriceFallingValidator
        : AbstractValidator<GetProductsListByPriceFallingQuery>
    {
        public GetProductsListByPriceFallingValidator(IDataBaseContext dbContext)
        {
