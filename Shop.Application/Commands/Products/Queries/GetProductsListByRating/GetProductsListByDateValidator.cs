...
{
    public class GetProductsListByDateValidator
        : AbstractValidator<GetProductsListByRatingQuery>
    {
        public GetProductsListByDateValidator(IDataBaseContext dbContext)
        {
